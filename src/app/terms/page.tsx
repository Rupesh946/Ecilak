    ...
    <div className="pt-24 pb-16">
      <div className="container-wide max-w-3xl">
        ...
        <div className="space-y-8 text-warm-gray-600 font-sans text-sm leading-relaxed">
          ...
          <p>3. The Platform is owned by 91384 09991, a company incorporated under the Companies Act, 1956 with its registered office at laxman chotra hansi (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').</p>
