export const metadata = {
  ...
  description: "Ecilak Terms & Conditions",
};
    ...
    <div className="pt-24 pb-16">
      <div className="container-wide max-w-3xl">
        <div className="text-center mb-14">
          <h1 className="font-serif text-4xl md:text-5xl text-warm-gray-900 mb-4">Terms & Conditions</h1>
        </div>
        <div className="space-y-8 text-warm-gray-600 font-sans text-sm leading-relaxed">
          ...
          <p>2. This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://ecilak.vercel.app/ (&apos;Website&apos;), including the related mobile site and mobile application (hereinafter referred to as &apos;Platform&apos;).</p>
          <p>3. The Platform is owned by 91384 09991, a company incorporated under the Companies Act, 1956 with its registered office at laxman chotra hansi (hereinafter referred to as &lsquo;Platform Owner&rsquo;, &apos;we&apos;, &apos;us&apos;, &apos;our&apos;).</p>
          ...
          <p>5. For the purpose of these Terms of Use, wherever the context so requires &lsquo;you&rsquo;, &apos;your&apos; or &lsquo;user&rsquo; shall mean any natural or legal person who has agreed to become a user/buyer on the Platform.</p>
          ...
          <section>
            <h2 className="font-serif text-xl text-warm-gray-900 mb-3">Contact</h2>
