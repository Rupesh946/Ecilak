export const metadata = {
  ...
  description: "Ecilak Privacy Policy",
};
    ...
    <div className="pt-24 pb-16">
      <div className="container-wide max-w-3xl">
        ...
        <div className="space-y-8 text-warm-gray-600 font-sans text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-serif text-xl text-warm-gray-900 mb-3">Sharing</h2>
          ...
          <section>
            <h2 className="font-serif text-xl text-warm-gray-900 mb-3">Security Precautions</h2>
          ...
          <section>
            <h2 className="font-serif text-xl text-warm-gray-900 mb-3">Data Deletion and Retention</h2>
          ...
          <section>
            <h2 className="font-serif text-xl text-warm-gray-900 mb-3">Your Rights</h2>
            <p>You may access, rectify, and update your personal data directly through the functionalities provided on the Platform.</p>
          </section>

          <section>
            <h2 className="font-serif text-xl text-warm-gray-900 mb-3">Consent</h2>
          ...
          <section>
            <h2 className="font-serif text-xl text-warm-gray-900 mb-3">Changes to this Privacy Policy</h2>
          ...
          <section>
            <h2 className="font-serif text-xl text-warm-gray-900 mb-3">Grievance Officer</h2>
            <p>Insert Name of the Office:<br />Designation:<br />Insert Name and Address of the Company: laxman chotra hansi</p>
          </section>
          
          <section>
            <h2 className="font-serif text-xl text-warm-gray-900 mb-3">Contact us</h2>
            <p>Email: <a href="mailto:ecilakbusiness@gmail.com" className="text-terracotta-400 hover:underline">ecilakbusiness@gmail.com</a></p>
            <p>Phone: 91384 09991<br />Time: Monday - Friday(9:00 - 18:00)</p>
            <p>Address: laxman chotra hansi</p>
          </section>
        </div>
      </div>
    </div>
